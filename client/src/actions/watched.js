...
export const postWatchedMovie = (user_id, movie_id, rate, title, poster_path, genres) => async (dispatch) => {
	try {
		const config = {
			headers: {
		...
		const body = JSON.stringify({ user_id, movie_id, rate, title, poster_path, genres });
