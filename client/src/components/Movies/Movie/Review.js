...
const Review = ({ username, rate, avatar, likes, comment, handleLikeSubmit, id }) => {
	return (
		<div className='col-12 border-bottom mb-1'>
			<div className='row'>
				<div className='col-12 review-avatar'>
					<img className='rounded-circle  mr-2' width='35px' alt='avatar' src={avatar} />
					...
					<div>
						<div className='media'>
							<span className='media-left mr-2'>
								<img onClick={() => handleLikeSubmit(id)} src={like} alt='like' width='15px' />
							</span>
