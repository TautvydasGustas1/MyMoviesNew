...
let pageSearchValue = '';
const SearchPage = ({ searchMovie, clearState, movies: { movies: { page, total_pages, results } }, loading }) => {
	useEffect(
		() => {
			clearState();
		},
...
export default connect(mapStateToProps, { searchMovie, clearState })(SearchPage);
