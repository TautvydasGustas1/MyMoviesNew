...
const Toolbar = ({ auth: { loading, isAuthenticated, user }, drawerClickHandler, logout }) => {
			...
			<nav className='navbar_navigation'>
				...
				<div className='navbar_navigation-items'>
					<div className='navbar_primary-links'>
						<ul>
							<li>
								<Link to='/movies/browse/trending'>Movies library</Link>
							</li>
							<li>
				...
				<div className='navbar_navigation-items'>{!loading && (isAuthenticated ? authLinks : guestLinks)}</div>
			</nav>
		</header>
	);
};
