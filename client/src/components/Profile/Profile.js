...
const Profile = ({
    getUserProfile,
    match,
    profile: { loading, profile, watched }
}) => {
    useEffect(() => {
                ...
                <Fragment>
                    <div className='card'>
                        <div
                            ...
                            style={{
                                backgroundImage:
                                    'linear-gradient(to top, #848484, #e1e1e1)'
                            }}
                        >
                            <div
                        ...
                        <div className='profile-buttons_container text-center'>
                            <div className='row h-100'>
                                <div
                                    onClick={() =>
                                        changeHalfPage('stats', active)
                                    }
                                    className={`col-6 pr-0 profile-button border-right ${
                                ...
                                <div
                                    onClick={() =>
                                        changeHalfPage('watched', active)
                                    }
                                    className={`col-6 pl-0 profile-button ${
